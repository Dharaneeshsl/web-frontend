  ...
  return (
    ...
    <div className="dashboard-cont">
      ...
      <div className="dashboard-grid">
        <div className="grid-item item-statistics"><div className="flex3"><div className="flex1">
          <div className="widget-title statlarge">Statistics</div>
          <div className="subtitle statsmall">Total Clicks</div></div>
          <div className="flex2"><div className="large-value intlarge">1,027</div>
          <div className="percentage-change positive-change intsmall">+12.75%</div></div></div>
